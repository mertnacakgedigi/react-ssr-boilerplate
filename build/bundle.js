...
exports.default = function () {
    var store = (0, _reactRedux.createStore)(_reducers2.default, {}, (0, _reactRedux.applyMiddleware)(_reduxThunk2.default));
    return store;
};
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return _axios2.default.get("http://react-ssr-api.com/users");
